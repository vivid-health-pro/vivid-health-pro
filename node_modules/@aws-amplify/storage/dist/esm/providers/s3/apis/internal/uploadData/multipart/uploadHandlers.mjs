...
const getMultipartUploadHandlers = (ctx, uploadDataInput, size) => {
    ...
    const startUpload = async () => {
        ...
        const resolvedS3Options = await resolveS3ConfigAndInput(ctx.amplify, uploadDataInput);
        ...
        const optionsHash = await calculateContentCRC32(ctx, serializeUploadOptions(uploadDataOptions));
        if (!inProgressUpload) {
