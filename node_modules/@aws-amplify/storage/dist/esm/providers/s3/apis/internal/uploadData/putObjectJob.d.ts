 ...
 * @internal
 */
export declare const putObjectJob: (ctx: FoundationContext, uploadDataInput: SinglePartUploadDataInput, abortSignal: AbortSignal, totalLength: number) => () => Promise<ItemWithKey | ItemWithPath>;
