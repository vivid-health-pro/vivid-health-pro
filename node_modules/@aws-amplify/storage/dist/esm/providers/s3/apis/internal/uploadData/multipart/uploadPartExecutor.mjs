import { calculateContentCRC32 } from '../../../../../../foundation/utils/crc32.mjs';
import { calculateContentMd5 } from '../../../../../../foundation/utils/md5.mjs';
...
const uploadPartExecutor = async ({ ctx, dataChunkerGenerator, completedPartNumberSet, s3Config, abortSignal, bucket, finalKey, uploadId, onPartUploadCompletion, onProgress, isObjectLockEnabled, useCRC32Checksum, expectedBucketOwner, }) => {
