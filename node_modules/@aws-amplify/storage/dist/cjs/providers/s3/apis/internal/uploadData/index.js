...
const uploadData = (ctx, input) => {
    ...
    if (dataByteLength <= constants_1.DEFAULT_PART_SIZE) {
        ...
        return (0, utils_1.createUploadTask)({
            ...
            job: (0, putObjectJob_1.putObjectJob)(ctx, input, abortController.signal, dataByteLength),
            onCancel: (message) => {
        ...
        // Multipart upload
        const { multipartUploadJob, onPause, onResume, onCancel } = (0, multipart_1.getMultipartUploadHandlers)(ctx, input, dataByteLength);
        return (0, utils_1.createUploadTask)({
