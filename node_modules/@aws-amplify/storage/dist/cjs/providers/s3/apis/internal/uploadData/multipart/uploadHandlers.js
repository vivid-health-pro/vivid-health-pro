...
const utils_4 = require("../../../../../../foundation/utils");
 ...
 * @internal
 */
const getMultipartUploadHandlers = (ctx, uploadDataInput, size) => {
    let resolveCallback;
    let rejectCallback;
    ...
    const startUpload = async () => {
        ...
        const resolvedS3Options = await (0, utils_2.resolveS3ConfigAndInput)(ctx.amplify, uploadDataInput);
        ...
        const optionsHash = await (0, utils_4.calculateContentCRC32)(ctx, (0, uploadCache_1.serializeUploadOptions)(uploadDataOptions));
        if (!inProgressUpload) {
