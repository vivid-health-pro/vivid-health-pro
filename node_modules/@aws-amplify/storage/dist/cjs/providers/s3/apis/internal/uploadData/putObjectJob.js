...
const utils_2 = require("../../../../../foundation/utils");
 ...
 * @internal
 */
const putObjectJob = (ctx, uploadDataInput, abortSignal, totalLength) => async () => {
    const { options: uploadDataOptions, data } = uploadDataInput;
    const { bucket, keyPrefix, s3Config, isObjectLockEnabled, identityId } = await (0, utils_3.resolveS3ConfigAndInput)(ctx.amplify, uploadDataInput);
    const { inputType, objectKey } = (0, utils_3.validateStorageOperationInput)(uploadDataInput, identityId);
    (0, utils_3.validateBucketOwnerID)(uploadDataOptions?.expectedBucketOwner);
