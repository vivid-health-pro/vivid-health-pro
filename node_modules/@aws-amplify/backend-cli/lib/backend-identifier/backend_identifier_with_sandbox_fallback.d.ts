...
export declare class BackendIdentifierResolverWithFallback implements BackendIdentifierResolver {
    ...
    resolveDeployedBackendIdentifier: (args: BackendIdentifierParameters) => Promise<{
        namespace: Readonly<import("@aws-amplify/plugin-types").AppId>;
        name: Readonly<import("@aws-amplify/plugin-types").BranchName>;
        type: Readonly<Extract<import("@aws-amplify/plugin-types").DeploymentType, "branch">>;
        hash?: Readonly<string>;
    } | {
        namespace: Readonly<import("@aws-amplify/plugin-types").ProjectName>;
        name: Readonly<import("@aws-amplify/plugin-types").SandboxName>;
        type: Readonly<Extract<import("@aws-amplify/plugin-types").DeploymentType, "sandbox">>;
        hash?: Readonly<string>;
    } | {
        namespace: Readonly<import("@aws-amplify/plugin-types").ProjectName>;
        name: Readonly<import("@aws-amplify/plugin-types").BranchName>;
        type: Readonly<Extract<import("@aws-amplify/plugin-types").DeploymentType, "standalone">>;
        hash?: Readonly<string>;
