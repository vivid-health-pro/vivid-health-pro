...
export declare const createSearchableDomain: (stack: Construct, parameterMap: Map<string, CfnParameter>, apiId: string, nodeToNodeEncryption: boolean, encryptionAtRest: boolean) => Domain;
