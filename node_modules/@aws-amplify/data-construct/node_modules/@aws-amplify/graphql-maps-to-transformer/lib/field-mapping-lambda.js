...
const createMappingLambda = (host, stackManager) => {
    ...
    const lambdaFunc = host.addLambdaFunction(funcLogicalId, `functions/${funcLogicalId}.zip`, 'index.handler', path.join(__dirname, 'assets', 'mapping-lambda.zip'), lambda.Runtime.NODEJS_24_X, undefined, role, undefined, cdk.Duration.seconds(30), stack);
