...
class SearchableModelTransformer extends graphql_transformer_core_1.TransformerPluginBase {
    constructor() {
        ...
        this.generateResolvers = (context) => {
            ...
            const domain = (0, create_searchable_domain_1.createSearchableDomain)(stack, parameterMap, context.api.apiId, context.transformParameters.enableSearchNodeToNodeEncryption, context.transformParameters.enableSearchEncryptionAtRest);
