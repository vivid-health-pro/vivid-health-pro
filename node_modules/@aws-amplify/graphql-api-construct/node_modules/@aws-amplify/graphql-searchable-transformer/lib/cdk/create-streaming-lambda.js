...
const createLambda = (scope, apiGraphql, parameterMap, lambdaRole, endpoint, isProjectUsingDataStore, region) => {
    ...
    return apiGraphql.host.addLambdaFunction(OpenSearchStreamingLambdaFunctionLogicalID, `functions/${OpenSearchStreamingLambdaFunctionLogicalID}.zip`, parameterMap.get(OpenSearchStreamingLambdaHandlerName).valueAsString, path.resolve(__dirname, '..', '..', 'lib', 'streaming-lambda.zip'), aws_lambda_1.Runtime.PYTHON_3_13, [], lambdaRole, enviroment, undefined, scope);
};
