...
export type AmplifyDataError = 'DefineDataConfigurationError' | 'InvalidPathError' | 'InvalidSchemaAuthError' | 'InvalidSchemaError' | 'MultipleSingletonResourcesError' | 'UnresolvedEntryPathError';
/**
