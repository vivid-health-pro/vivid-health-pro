...
export function buildScalarsFromConfig(schema, config, defaultScalarsMapping = DEFAULT_SCALARS, defaultScalarType = 'unknown') {
...
export function buildScalars(schema, scalarsMapping, defaultScalarsMapping = DEFAULT_SCALARS, defaultScalarType = 'unknown') {
    const result = {};
 ...
 */
export const printTypeScriptMaybeType = ({ type, pattern, }) => {
