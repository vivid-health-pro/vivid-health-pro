...
exports.printTypeScriptMaybeType = exports.getNodeComment = exports.getFieldNames = exports.getFieldNodeNameValue = exports.REQUIRE_FIELDS_TYPE = exports.OMIT_TYPE = exports.DeclarationBlock = exports.getConfigValue = void 0;
...
function buildScalarsFromConfig(schema, config, defaultScalarsMapping = scalars_js_1.DEFAULT_SCALARS, defaultScalarType = 'unknown') {
...
function buildScalars(schema, scalarsMapping, defaultScalarsMapping = scalars_js_1.DEFAULT_SCALARS, defaultScalarType = 'unknown') {
    const result = {};
    ...
    if (schema) {
        ...
        Object.keys(typeMap)
            ...
            if (typeof scalarsMapping === 'string') {
                ...
                else if (typeof mappedScalar === 'object' &&
                    mappedScalar.input &&
                    mappedScalar.output) {
                    result[name] = {
...
function getFullPathFieldName(selection, parentName) {
    const fullName = 'alias' in selection && selection.alias
 ...
 */
const printTypeScriptMaybeType = ({ type, pattern, }) => {
...
exports.printTypeScriptMaybeType = printTypeScriptMaybeType;
