import { DirectiveNode, EnumValueDefinitionNode, FieldDefinitionNode, FieldNode, FragmentSpreadNode, GraphQLInputObjectType, GraphQLNamedType, GraphQLObjectType, GraphQLOutputType, GraphQLSchema, InlineFragmentNode, InputValueDefinitionNode, NamedTypeNode, NameNode, SelectionNode, SelectionSetNode, StringValueNode, TypeNode } from 'graphql';
import { RawConfig } from './base-visitor.cjs';
import { LoadedFragment, NormalizedScalarsMap, ParsedScalarsMap, ScalarsMap } from './types.cjs';
 ...
 */
export declare function hasIncrementalDeliveryDirectives(directives?: readonly DirectiveNode[]): boolean;
 ...
 */
export declare const printTypeScriptMaybeType: ({ type, pattern, }: {
    type: string;
    pattern: string;
}) => string;
export {};
