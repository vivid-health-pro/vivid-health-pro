 ...
 */
export declare class WebsiteNoticeDataSourceProps {
    /**
...
export declare class WebsiteNoticeDataSource implements NoticeDataSource {
    ...
    constructor(ioHelper: IoHelper, props?: WebsiteNoticeDataSourceProps);
    fetch(): Promise<Notice[]>;
}
//# sourceMappingURL=web-data-source.d.ts.map