...
export declare function prepareDiff(ioHelper: IoHelper, stacks: StackCollection, deployments: Deployments, sdkProvider: SdkProvider, options: DiffOptions): Promise<TemplateInfo[]>;
/**
