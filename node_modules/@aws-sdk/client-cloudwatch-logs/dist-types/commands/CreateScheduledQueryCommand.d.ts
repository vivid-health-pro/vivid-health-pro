...
declare const CreateScheduledQueryCommand_base: {
    new (input: CreateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledQueryCommandInput, CreateScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateScheduledQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledQueryCommandInput, CreateScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
