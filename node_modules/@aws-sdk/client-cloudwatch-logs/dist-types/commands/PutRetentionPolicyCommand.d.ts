...
declare const PutRetentionPolicyCommand_base: {
    new (input: PutRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionPolicyCommandInput, PutRetentionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutRetentionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionPolicyCommandInput, PutRetentionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
