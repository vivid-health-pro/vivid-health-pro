...
declare const GetLogObjectCommand_base: {
    new (input: GetLogObjectCommandInput): import("@smithy/core/client").CommandImpl<GetLogObjectCommandInput, GetLogObjectCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetLogObjectCommandInput): import("@smithy/core/client").CommandImpl<GetLogObjectCommandInput, GetLogObjectCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
