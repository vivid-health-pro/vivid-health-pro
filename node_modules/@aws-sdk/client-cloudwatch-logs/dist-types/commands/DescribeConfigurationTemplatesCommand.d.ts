...
declare const DescribeConfigurationTemplatesCommand_base: {
    new (input: DescribeConfigurationTemplatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeConfigurationTemplatesCommandInput, DescribeConfigurationTemplatesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeConfigurationTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeConfigurationTemplatesCommandInput, DescribeConfigurationTemplatesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
