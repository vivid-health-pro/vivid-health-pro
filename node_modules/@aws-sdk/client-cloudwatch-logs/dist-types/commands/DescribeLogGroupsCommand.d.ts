...
declare const DescribeLogGroupsCommand_base: {
    new (input: DescribeLogGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLogGroupsCommandInput, DescribeLogGroupsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLogGroupsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLogGroupsCommandInput, DescribeLogGroupsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
