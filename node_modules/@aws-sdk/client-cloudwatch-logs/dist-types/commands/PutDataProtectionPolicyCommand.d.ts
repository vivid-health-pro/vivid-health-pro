...
declare const PutDataProtectionPolicyCommand_base: {
    new (input: PutDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutDataProtectionPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutDataProtectionPolicyCommandInput, PutDataProtectionPolicyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
