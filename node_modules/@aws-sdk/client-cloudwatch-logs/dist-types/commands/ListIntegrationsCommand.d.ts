...
declare const ListIntegrationsCommand_base: {
    new (input: ListIntegrationsCommandInput): import("@smithy/core/client").CommandImpl<ListIntegrationsCommandInput, ListIntegrationsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListIntegrationsCommandInput]): import("@smithy/core/client").CommandImpl<ListIntegrationsCommandInput, ListIntegrationsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
