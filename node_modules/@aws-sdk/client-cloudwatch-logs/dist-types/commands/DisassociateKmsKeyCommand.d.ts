...
declare const DisassociateKmsKeyCommand_base: {
    new (input: DisassociateKmsKeyCommandInput): import("@smithy/core/client").CommandImpl<DisassociateKmsKeyCommandInput, DisassociateKmsKeyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisassociateKmsKeyCommandInput]): import("@smithy/core/client").CommandImpl<DisassociateKmsKeyCommandInput, DisassociateKmsKeyCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
