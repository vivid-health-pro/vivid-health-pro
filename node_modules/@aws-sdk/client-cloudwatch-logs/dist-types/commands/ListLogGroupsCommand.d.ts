...
declare const ListLogGroupsCommand_base: {
    new (input: ListLogGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListLogGroupsCommandInput, ListLogGroupsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListLogGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListLogGroupsCommandInput, ListLogGroupsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
