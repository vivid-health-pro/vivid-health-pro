...
declare const GetTrafficPolicyInstanceCommand_base: {
    new (input: GetTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyInstanceCommandInput, GetTrafficPolicyInstanceCommandOutput, Route53ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyInstanceCommandInput, GetTrafficPolicyInstanceCommandOutput, Route53ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
