...
declare const GetHealthCheckCountCommand_base: {
    new (input: GetHealthCheckCountCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckCountCommandInput, GetHealthCheckCountCommandOutput, Route53ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetHealthCheckCountCommandInput]): import("@smithy/core/client").CommandImpl<GetHealthCheckCountCommandInput, GetHealthCheckCountCommandOutput, Route53ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
