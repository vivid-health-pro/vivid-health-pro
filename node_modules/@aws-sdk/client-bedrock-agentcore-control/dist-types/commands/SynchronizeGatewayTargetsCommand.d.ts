...
declare const SynchronizeGatewayTargetsCommand_base: {
    new (input: SynchronizeGatewayTargetsCommandInput): import("@smithy/core/client").CommandImpl<SynchronizeGatewayTargetsCommandInput, SynchronizeGatewayTargetsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SynchronizeGatewayTargetsCommandInput): import("@smithy/core/client").CommandImpl<SynchronizeGatewayTargetsCommandInput, SynchronizeGatewayTargetsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
