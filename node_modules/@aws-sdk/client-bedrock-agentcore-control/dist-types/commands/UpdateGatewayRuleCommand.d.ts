...
declare const UpdateGatewayRuleCommand_base: {
    new (input: UpdateGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayRuleCommandInput, UpdateGatewayRuleCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateGatewayRuleCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayRuleCommandInput, UpdateGatewayRuleCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
