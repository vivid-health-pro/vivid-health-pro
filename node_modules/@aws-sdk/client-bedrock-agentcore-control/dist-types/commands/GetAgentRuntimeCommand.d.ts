...
declare const GetAgentRuntimeCommand_base: {
    new (input: GetAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<GetAgentRuntimeCommandInput, GetAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<GetAgentRuntimeCommandInput, GetAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
