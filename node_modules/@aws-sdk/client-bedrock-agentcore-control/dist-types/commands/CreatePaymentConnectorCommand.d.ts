...
declare const CreatePaymentConnectorCommand_base: {
    new (input: CreatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentConnectorCommandInput, CreatePaymentConnectorCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<CreatePaymentConnectorCommandInput, CreatePaymentConnectorCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
