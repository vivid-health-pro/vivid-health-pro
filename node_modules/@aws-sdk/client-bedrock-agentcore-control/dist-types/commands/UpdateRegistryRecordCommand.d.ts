...
declare const UpdateRegistryRecordCommand_base: {
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<UpdateRegistryRecordCommandInput, UpdateRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
