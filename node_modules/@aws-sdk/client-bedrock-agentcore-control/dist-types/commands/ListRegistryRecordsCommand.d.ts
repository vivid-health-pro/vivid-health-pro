...
declare const ListRegistryRecordsCommand_base: {
    new (input: ListRegistryRecordsCommandInput): import("@smithy/core/client").CommandImpl<ListRegistryRecordsCommandInput, ListRegistryRecordsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListRegistryRecordsCommandInput): import("@smithy/core/client").CommandImpl<ListRegistryRecordsCommandInput, ListRegistryRecordsCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
