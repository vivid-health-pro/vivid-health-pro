...
declare const GetRegistryRecordCommand_base: {
    new (input: GetRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryRecordCommandInput, GetRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetRegistryRecordCommandInput): import("@smithy/core/client").CommandImpl<GetRegistryRecordCommandInput, GetRegistryRecordCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
