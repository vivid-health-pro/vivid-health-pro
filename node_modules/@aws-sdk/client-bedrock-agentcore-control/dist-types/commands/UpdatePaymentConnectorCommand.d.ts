...
declare const UpdatePaymentConnectorCommand_base: {
    new (input: UpdatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentConnectorCommandInput, UpdatePaymentConnectorCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdatePaymentConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdatePaymentConnectorCommandInput, UpdatePaymentConnectorCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
