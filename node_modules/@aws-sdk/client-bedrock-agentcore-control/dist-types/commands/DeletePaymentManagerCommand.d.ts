...
declare const DeletePaymentManagerCommand_base: {
    new (input: DeletePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentManagerCommandInput, DeletePaymentManagerCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeletePaymentManagerCommandInput): import("@smithy/core/client").CommandImpl<DeletePaymentManagerCommandInput, DeletePaymentManagerCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
