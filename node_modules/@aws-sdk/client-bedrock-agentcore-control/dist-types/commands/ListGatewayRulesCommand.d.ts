...
declare const ListGatewayRulesCommand_base: {
    new (input: ListGatewayRulesCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayRulesCommandInput, ListGatewayRulesCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListGatewayRulesCommandInput): import("@smithy/core/client").CommandImpl<ListGatewayRulesCommandInput, ListGatewayRulesCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
