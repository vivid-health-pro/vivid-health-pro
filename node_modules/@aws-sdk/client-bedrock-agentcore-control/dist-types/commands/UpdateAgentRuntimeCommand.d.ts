...
declare const UpdateAgentRuntimeCommand_base: {
    new (input: UpdateAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<UpdateAgentRuntimeCommandInput, UpdateAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateAgentRuntimeCommandInput): import("@smithy/core/client").CommandImpl<UpdateAgentRuntimeCommandInput, UpdateAgentRuntimeCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
