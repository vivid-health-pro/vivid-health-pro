...
declare const GetGatewayTargetCommand_base: {
    new (input: GetGatewayTargetCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayTargetCommandInput, GetGatewayTargetCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetGatewayTargetCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayTargetCommandInput, GetGatewayTargetCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
