...
declare const DeletePolicyEngineCommand_base: {
    new (input: DeletePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyEngineCommandInput, DeletePolicyEngineCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeletePolicyEngineCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyEngineCommandInput, DeletePolicyEngineCommandOutput, BedrockAgentCoreControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
