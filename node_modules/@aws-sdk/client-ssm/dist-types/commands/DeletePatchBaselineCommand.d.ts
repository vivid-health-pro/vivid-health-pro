...
import type { DeletePatchBaselineRequest, DeletePatchBaselineResult } from "../models/models_0";
...
declare const DeletePatchBaselineCommand_base: {
    new (input: DeletePatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<DeletePatchBaselineCommandInput, DeletePatchBaselineCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeletePatchBaselineCommandInput): import("@smithy/core/client").CommandImpl<DeletePatchBaselineCommandInput, DeletePatchBaselineCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
