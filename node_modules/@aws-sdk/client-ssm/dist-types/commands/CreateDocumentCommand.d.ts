...
import type { CreateDocumentRequest, CreateDocumentResult } from "../models/models_0";
...
declare const CreateDocumentCommand_base: {
    new (input: CreateDocumentCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentCommandInput, CreateDocumentCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateDocumentCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentCommandInput, CreateDocumentCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
