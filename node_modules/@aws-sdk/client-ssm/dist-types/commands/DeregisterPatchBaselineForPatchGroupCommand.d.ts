...
import type { DeregisterPatchBaselineForPatchGroupRequest, DeregisterPatchBaselineForPatchGroupResult } from "../models/models_0";
...
declare const DeregisterPatchBaselineForPatchGroupCommand_base: {
    new (input: DeregisterPatchBaselineForPatchGroupCommandInput): import("@smithy/core/client").CommandImpl<DeregisterPatchBaselineForPatchGroupCommandInput, DeregisterPatchBaselineForPatchGroupCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeregisterPatchBaselineForPatchGroupCommandInput): import("@smithy/core/client").CommandImpl<DeregisterPatchBaselineForPatchGroupCommandInput, DeregisterPatchBaselineForPatchGroupCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
