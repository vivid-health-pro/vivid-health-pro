...
import type { DescribeAssociationExecutionTargetsRequest, DescribeAssociationExecutionTargetsResult } from "../models/models_0";
...
declare const DescribeAssociationExecutionTargetsCommand_base: {
    new (input: DescribeAssociationExecutionTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAssociationExecutionTargetsCommandInput, DescribeAssociationExecutionTargetsCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeAssociationExecutionTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAssociationExecutionTargetsCommandInput, DescribeAssociationExecutionTargetsCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
