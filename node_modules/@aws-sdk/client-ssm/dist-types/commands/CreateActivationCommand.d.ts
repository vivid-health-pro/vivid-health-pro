...
import type { CreateActivationRequest, CreateActivationResult } from "../models/models_0";
...
declare const CreateActivationCommand_base: {
    new (input: CreateActivationCommandInput): import("@smithy/core/client").CommandImpl<CreateActivationCommandInput, CreateActivationCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateActivationCommandInput): import("@smithy/core/client").CommandImpl<CreateActivationCommandInput, CreateActivationCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
