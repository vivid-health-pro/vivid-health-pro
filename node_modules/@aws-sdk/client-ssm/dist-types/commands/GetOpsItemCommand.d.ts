...
import type { GetOpsItemRequest, GetOpsItemResponse } from "../models/models_0";
...
declare const GetOpsItemCommand_base: {
    new (input: GetOpsItemCommandInput): import("@smithy/core/client").CommandImpl<GetOpsItemCommandInput, GetOpsItemCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetOpsItemCommandInput): import("@smithy/core/client").CommandImpl<GetOpsItemCommandInput, GetOpsItemCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
