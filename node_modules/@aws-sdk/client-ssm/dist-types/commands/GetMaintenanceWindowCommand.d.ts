...
import type { GetMaintenanceWindowRequest, GetMaintenanceWindowResult } from "../models/models_0";
...
declare const GetMaintenanceWindowCommand_base: {
    new (input: GetMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowCommandInput, GetMaintenanceWindowCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<GetMaintenanceWindowCommandInput, GetMaintenanceWindowCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
