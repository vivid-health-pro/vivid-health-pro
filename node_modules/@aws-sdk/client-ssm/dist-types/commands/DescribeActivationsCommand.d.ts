...
declare const DescribeActivationsCommand_base: {
    new (input: DescribeActivationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeActivationsCommandInput, DescribeActivationsCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeActivationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeActivationsCommandInput, DescribeActivationsCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
