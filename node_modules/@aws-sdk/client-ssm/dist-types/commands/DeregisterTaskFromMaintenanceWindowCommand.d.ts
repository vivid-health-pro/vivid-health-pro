...
import type { DeregisterTaskFromMaintenanceWindowRequest, DeregisterTaskFromMaintenanceWindowResult } from "../models/models_0";
...
declare const DeregisterTaskFromMaintenanceWindowCommand_base: {
    new (input: DeregisterTaskFromMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTaskFromMaintenanceWindowCommandInput, DeregisterTaskFromMaintenanceWindowCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeregisterTaskFromMaintenanceWindowCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTaskFromMaintenanceWindowCommandInput, DeregisterTaskFromMaintenanceWindowCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
