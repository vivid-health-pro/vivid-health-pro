...
import type { CancelMaintenanceWindowExecutionRequest, CancelMaintenanceWindowExecutionResult } from "../models/models_0";
...
declare const CancelMaintenanceWindowExecutionCommand_base: {
    new (input: CancelMaintenanceWindowExecutionCommandInput): import("@smithy/core/client").CommandImpl<CancelMaintenanceWindowExecutionCommandInput, CancelMaintenanceWindowExecutionCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CancelMaintenanceWindowExecutionCommandInput): import("@smithy/core/client").CommandImpl<CancelMaintenanceWindowExecutionCommandInput, CancelMaintenanceWindowExecutionCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
