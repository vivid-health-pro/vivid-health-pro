...
declare const UnlabelParameterVersionCommand_base: {
    new (input: UnlabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<UnlabelParameterVersionCommandInput, UnlabelParameterVersionCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UnlabelParameterVersionCommandInput): import("@smithy/core/client").CommandImpl<UnlabelParameterVersionCommandInput, UnlabelParameterVersionCommandOutput, SSMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
