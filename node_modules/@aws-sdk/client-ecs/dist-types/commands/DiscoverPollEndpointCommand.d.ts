...
declare const DiscoverPollEndpointCommand_base: {
    new (input: DiscoverPollEndpointCommandInput): import("@smithy/core/client").CommandImpl<DiscoverPollEndpointCommandInput, DiscoverPollEndpointCommandOutput, ECSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DiscoverPollEndpointCommandInput]): import("@smithy/core/client").CommandImpl<DiscoverPollEndpointCommandInput, DiscoverPollEndpointCommandOutput, ECSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
