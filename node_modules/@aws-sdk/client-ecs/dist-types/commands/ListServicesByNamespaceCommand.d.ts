...
declare const ListServicesByNamespaceCommand_base: {
    new (input: ListServicesByNamespaceCommandInput): import("@smithy/core/client").CommandImpl<ListServicesByNamespaceCommandInput, ListServicesByNamespaceCommandOutput, ECSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListServicesByNamespaceCommandInput): import("@smithy/core/client").CommandImpl<ListServicesByNamespaceCommandInput, ListServicesByNamespaceCommandOutput, ECSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
