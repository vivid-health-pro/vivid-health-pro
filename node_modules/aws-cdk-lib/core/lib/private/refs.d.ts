 ...
 */
export declare class CustomCoupledReference extends Intrinsic {
    static isCustomCoupledReference(x: IResolvable): x is CustomCoupledReference;
    ...
    assignValue(value: IResolvable): void;
